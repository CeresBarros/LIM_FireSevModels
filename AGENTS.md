...
- **Stage 3 — in progress**: `CASFRIrelated_functions.R` (22 functions total; tiered — full roxygen for the 5 wrappers, short title + `@param` for the 17 internal recoders).
