...
SKToCASFRI <- function(inv, tablesDir, folder, dim) {
  ...
  casfriDT[is.na(DIST2_EXTENT_UPPER), DIST2_EXTENT_UPPER := ERRCODE]
  casfriDT[is.na(DIST3_EXTENT_UPPER), DIST3_EXTENT_UPPER := ERRCODE]
  casfriDT[is.na(DIST1_EXTENT_LOWER), DIST1_EXTENT_LOWER := ERRCODE]
  casfriDT[is.na(DIST2_EXTENT_LOWER), DIST2_EXTENT_LOWER := ERRCODE]
  casfriDT[is.na(DIST3_EXTENT_LOWER), DIST3_EXTENT_LOWER := ERRCODE]
